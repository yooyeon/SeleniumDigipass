...
public class RegisterNewOperator {
	...
	@Test
	public  void mainRegisterNewOperator() throws InterruptedException, SQLException {
		/* run in db:  
		delete [training_history] where operator_id in (select id from operator where badge_num='44122')
		delete[operator] where badge_num='44122'
		*/
		...
		s.execute("delete [training_history] where operator_id in (select id from operator where badge_num='44122')");
		s.execute("delete [operator] where badge_num='44122'");

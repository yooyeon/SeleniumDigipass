...
public class ManageStation {
	...
	@Test
	public void mainManageStation () throws InterruptedException, SQLException {

		/* Connect to DB and run:  
		  delete [station] where  station_category_id in (select id from [station_category] where name ='testCategory')
		  delete [station_category_color_definition] where station_category_id in (select id from [station_category] where name ='testCategory')
		...
		s.execute("delete [station] where  station_category_id in (select id from [station_category] where name ='testCategory')");
		s.execute("delete [station_category_color_definition] where station_category_id in (select id from [station_category] where name ='testCategory')");
		s.execute("delete[station_category] where name ='testCategory'");
		...
		// Login to home page , and expand menu icons
				...
				int si= driver.findElements(By.xpath("//span[contains(text(),'testStation')]")).size();
				Assert.assertEquals(si, 3);
				System.out.println("Created three stations successfully!");
				...
				si= driver.findElements(By.xpath("//td[contains(text(),'VRV Receiver Brazer')]")).size();
				Assert.assertEquals(si, 3);
				...
				Thread.sleep(1000);
				si= driver.findElements(By.xpath("//span[contains(text(),'testStation10')]")).size();

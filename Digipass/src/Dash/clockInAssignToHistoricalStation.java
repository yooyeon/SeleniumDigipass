...
public class clockInAssignToHistoricalStation {
	...
	@Test
	public void mainClockInAssignToHistoricalStation( ) throws InterruptedException, SQLException {
		...
		System.out.println("Operator badge is : "+operator);
		...
		System.out.println("Operator has assigned to department: "+deptName+" in station: "+station);		

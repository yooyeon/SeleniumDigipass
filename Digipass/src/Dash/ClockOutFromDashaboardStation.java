...
public class ClockOutFromDashaboardStation {
	...
	@Test
	public void mainClockOutFromDashaboardStation( ) throws SQLException, InterruptedException {
				// Login to test WFD 
				...
				ResultSet rs= s.executeQuery("select top(2) * from dashboard_data where badge is not null order by user_modified_date desc");
